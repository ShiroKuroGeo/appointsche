                            ...
                            <div class="auth-form-light text-left py-4 px-4 px-sm-5 ">
                                ...
                                <form class="pt-3">
                                    <div class="form-group">
                                        <input class="form-control" type="text" v-model="email" id="email" placeholder="Enter email address" />
                                    </div>
                                    <div class="mt-3">
                                        <button type="button" @click="forgotPassword" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Forgot Password</button>
                                    </div>
